...
def index(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            resultado = simulacion(simbol,desde_string,hasta_string,tiempo_años,tasa_de_interes,precio,100,tipo)
            ...
            'desde_dia':desde_output, 'hasta_dia':hasta_output, 'tiempo_años':tiempo_años, 'tasa_de_interes':tasa_de_interes, 'precio_i':precio, 'nombre_empresa':name, 'tipo_opcion':tipo, 'opcion':opcion}
